...
-->
                                                <button type="button" class="btn waves-effect waves-light btn-rounded btn-outline-secondary" data-toggle="modal" data-target="#myModalProducto" data-id="" id="">Editar </button>
