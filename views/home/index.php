					...
					<div class="featured__item">
						<div class="featured__item__pic set-bg" data-setbg="/build/img/featured/feature-2.jpg">
							<ul class="featured__item__pic__hover">
								...
								<li><a href="/cart?id=<?php echo $producto->id; ?>"><i class="fa fa-shopping-cart"></i></a></li>
							</ul>
						</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="blog__item">
					<div class="blog__item__pic">
						<img src="/build/img/blog/blog-1.jpg" alt="">
					</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="blog__item">
					<div class="blog__item__pic">
						<img src="/build/img/blog/blog-2.jpg" alt="">
					</div>
					<div class="blog__item__text">
						<ul>
							<li><i class="fa fa-calendar-o"></i> May 4,2019</li>
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="blog__item">
					<div class="blog__item__pic">
						<img src="/build/img/blog/blog-3.jpg" alt="">
					</div>
					<div class="blog__item__text">
						<ul>
							<li><i class="fa fa-calendar-o"></i> May 4,2019</li>
